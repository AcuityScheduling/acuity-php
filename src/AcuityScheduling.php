...
class Scheduling
{
     ...
     * Request helper.
     */
    protected function __request($url, $options)
    {
    ...
    public static function getEmbedCode($owner, $options = array())
    {
        ...
        return
            "<iframe src=\"https://app.acuityscheduling.com/schedule.php?{$query}\"
            width=\"{$options['width']}\" height=\"{$options['height']}\" frameBorder=\"0\"></iframe>".
